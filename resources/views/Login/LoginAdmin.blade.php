...
<body>
    ...
    <div class="form-container">
        <div class="input-group">
            ...
            <input type="text" placeholder="Gmail" autocomplete="off">
        </div>
        <div class="input-group">
            <span class="icon">
        ...
        <div class="button-group">
            <button type="submit" style="font-family: Montserrat, sans-serif; font-weight: 600; color: #2148C0" id="openPopupBtn"> REGISTER ADMIN </button>
