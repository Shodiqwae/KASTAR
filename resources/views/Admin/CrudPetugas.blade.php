...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled components mb-5 list-sidebar" style="font-family: Montserrat, sans-serif; font-weight:500;">
                    ...
                    <li class="active">
                        <a href="#" style="font-size: 18px"><span><img src="{{ asset('images/user (1).png') }}" alt="" style="margin-right: 10px; margin-bottom:7px"></span> Petugas</a>
                    </li>
                    <li>
        ...
        <div id="content" class="p-4 p-md-4 pt-5">
            <h2 style="margin-left: 35px; font-family: Montserrat, sans-serif; font-weight:700; color: #1A4AE9;">Petugas</h2>
            <div class="divider"></div>

            <button class="button-Add btn btn-primary" data-toggle="modal" data-target="#addPetugasModal" style="font-family: Montserrat, sans-serif; font-weight: 600; color: #ffffff;">+ Add Petugas</button>
                ...
                <table class="table my-5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $user->alamat }}</td>
                            <td>
                                <button class="btn btn-warning" data-toggle="modal" data-target="#editPetugasModal{{ $user->id }}">Edit</button>
                                <form action="{{ route('CrudPetugas.destroy', $user->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <!-- Edit Petugas Modal -->
                        <div class="modal fade" id="editPetugasModal{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="editPetugasModalLabel{{ $user->id }}" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editPetugasModalLabel{{ $user->id }}">Edit Petugas</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form method="POST" action="{{ route('CrudPetugas.update', $user->id) }}">
                                            @csrf
                                            @method('PUT')
